...
public:
  ...
  Vertex* vt[3];    // tre puntatori a Vertice (i tre vertici della texutre)
  // costruttore
  Face(Vertex* a, Vertex* b, Vertex* c){
    v[0]=a; v[1]=b; v[2]=c;

  }
  void set_Texture(Vertex* a1, Vertex* b1, Vertex* c1){
      vt[0]=a1; vt[1]=b1; vt[2]=c1;
  }
...
class Mesh
{
  ...
  std::vector<Vertex> vt; // vettore di vertici
...
public:
  ...
  void RenderNxV(int id); // manda a schermo la mesh Normali x Vertice
  void RenderNxVnT(); // manda a schermo la mesh Normali x Vertice
